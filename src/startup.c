// queremos saber onde começa o stack
//  as informações da memoria estão presentes no datashet
...
void default_handler(void) // padrão para quando não soubermos oq fazer com as consultas indesejadas
{
    while (1)
    {};
}
